...
weatherCommons = WeatherCommons({"temperature": 1, "feelLikesTemperature": 1,
                                "relativeHumidity": 1, "weatherType": "type", "visibility": "moderate", "windDirection": 1, "windSpeed": 1, })
gSMAFIWAREWeatherForecastSchema = GSMAFIWAREWeatherForecastSchema(
    {"location": "Saint-Etienne", "alert": "tropicalCyclone", "date": "2021-01-01", "current": weatherCommons, "dayMinimum": weatherAirConditions, "dayMaximum": weatherAirConditions})
